...
export default function ReportsDashboard() {
  ...
  const getPriorityBadge = (priority: string) => {
    switch (priority) {
      ...
      default:
        return 'bg-raised text-ink-500 border-line-strong';
    }
  };
    ...
    <div className="flex h-full bg-paper text-ink-700 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-2xl font-bold text-ink-900 tracking-tight">Reports</h2>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center bg-paper border border-line rounded-lg px-3 py-1.5 text-xs text-ink-700 space-x-2">
                ...
                <input
                  ...
                  className="bg-transparent border-none focus:outline-none text-ink-700 w-48 text-xs"
                />
              </div>
              ...
              {/* PDF Export Button */}
              <button className="bg-rose-600 hover:bg-rose-500 text-ink-900 px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center space-x-2 shadow-lg shadow-rose-950/30 transition-all">
                <Download className="w-3.5 h-3.5" />
                <span>Export PDF</span>
              </button>

              {/* CSV Export Button */}
              <button className="bg-emerald-600 hover:bg-emerald-500 text-ink-900 px-3.5 py-1.5 rounded-lg text-xs font-semibold flex items-center space-x-2 shadow-lg shadow-emerald-950/30 transition-all">
                <Download className="w-3.5 h-3.5" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              <div
                key={idx}
                className="bg-paper border border-line rounded-xl p-4 space-y-3 relative overflow-hidden group hover:border-line-strong transition-colors"
              >
                ...
                <div>
                  <p className="text-2xl font-bold text-ink-900 tracking-tight">{stat.count}</p>
                  <p className="text-xs text-ink-500 mt-0.5">{stat.title}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-paper border border-line rounded-xl p-5 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-ink-900 text-sm">Reports Overview</h3>
                ...
                <select
                  ...
                  className="bg-paper border border-line text-xs text-ink-700 rounded-lg px-2.5 py-1 focus:outline-none"
                >
              ...
              <div className="h-48 w-full flex flex-col justify-end pt-4 relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-between pointer-events-none opacity-20">
                  <div className="border-b border-line-strong w-full"></div>
                  <div className="border-b border-line-strong w-full"></div>
                  <div className="border-b border-line-strong w-full"></div>
                  <div className="border-b border-line-strong w-full"></div>
                </div>
                ...
                {/* X-Axis Labels */}
                <div className="flex justify-between text-[10px] text-ink-500 pt-3 border-t border-line">
                  <span>29 Aug</span>
                  <span>30 Aug</span>
                  <span>31 Aug</span>
                  <span>1 Sep</span>
            ...
            <div className="lg:col-span-4 bg-paper border border-line rounded-xl p-5 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-ink-900 text-sm">Reports by Type</h3>
                  <p className="text-[11px] text-ink-500">Distribution breakdown</p>
                </div>
                <PieChartIcon className="w-4 h-4 text-ink-500" />
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="relative w-32 h-32 shrink-0">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                    <span className="text-sm font-bold text-ink-900">128</span>
                    <span className="text-[8px] text-ink-500">Total</span>
                  </div>
                </div>
                ...
                <div className="space-y-1.5 text-xs text-ink-700">
                  {[
                    ...
                    <div key={i} className="flex items-center space-x-2">
                      ...
                      <span className="text-[11px] text-ink-500 truncate w-24">
                        {leg.label}
                      </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
              ...
              <div className="md:col-span-4 relative">
                ...
                <input
                  ...
                  className="w-full bg-paper border border-line rounded-lg pl-9 pr-3 py-2 text-xs text-ink-700 placeholder-slate-500 focus:outline-none focus:border-blue-500"
                />
              </div>
          ...
          <div className="bg-paper border border-line rounded-xl overflow-hidden space-y-0">
            <div className="p-4 border-b border-line flex items-center justify-between">
              <h3 className="font-semibold text-ink-900 text-sm">Recent Reports</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead className="bg-paper text-ink-500 uppercase font-medium border-b border-line">
                  <tr>
                ...
                <tbody className="divide-y divide-line/60 text-ink-700">
                  {paginatedReports.length > 0 ? (
                    paginatedReports.map((rpt) => (
                      <tr key={rpt.id} className="hover:bg-raised/40 transition-colors">
                        <td className="py-3.5 px-4 font-mono text-blue-400 font-medium">
                          {rpt.id}
                        </td>
                        <td className="py-3.5 px-4 font-semibold text-ink-900">{rpt.name}</td>
                        <td className="py-3.5 px-4 text-ink-500">{rpt.type}</td>
                        <td className="py-3.5 px-4 text-ink-700">{rpt.generatedOn}</td>
                        <td className="py-3.5 px-4 text-ink-500">{rpt.dateRange}</td>
                        ...
                        <td className="py-3.5 px-4 text-ink-700">{rpt.generatedBy}</td>
                        <td className="py-3.5 px-4">
                          <span
                        ...
                        <td className="py-3.5 px-4 text-right relative">
                          <div className="flex items-center justify-end space-x-2">
                            ...
                            <button
                              ...
                              className="p-1 text-ink-500 hover:text-ink-900 rounded hover:bg-raised transition-colors"
                              title="View Details"
                            >
                          ...
                          {openMenuId === rpt.id && (
                            <div className="absolute right-4 top-10 w-40 bg-paper border border-line-strong rounded-lg shadow-xl py-1.5 z-30 text-left">
                              <button
                                onClick={() => {
                                  setPreviewReport(rpt);
                                  setOpenMenuId(null);
                                }}
                                className="w-full px-3 py-1.5 text-xs text-ink-700 hover:bg-raised flex items-center space-x-2"
                              >
                    ...
                    <tr>
                      <td colSpan={9} className="py-8 text-center text-ink-500 text-xs">
            ...
            {/* Pagination Controls */}
            <div className="p-4 border-t border-line flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-ink-500">
              <div className="flex items-center space-x-2">
                ...
                <select
                  ...
                  className="bg-paper border border-line rounded px-2 py-1 text-ink-700 focus:outline-none"
                >
              ...
              <div className="flex items-center space-x-1">
                <button
                  ...
                  className="p-1.5 bg-paper border border-line rounded hover:bg-raised text-ink-700 disabled:opacity-30 transition-colors"
                >
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map((pg) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded border text-xs font-semibold transition-colors ${
                      currentPage === pg
                        ? 'bg-blue-600 text-ink-900 border-blue-500'
                        : 'bg-paper border-line text-ink-500 hover:bg-raised'
                    }`}
                  >
                    {pg}
                  </button>
      ...
      {previewReport && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-paper border border-line rounded-2xl max-w-lg w-full p-6 space-y-5 shadow-2xl">
            <div className="flex items-center justify-between border-b border-line pb-3">
              <div>
                <span className="text-[10px] font-mono text-blue-400 font-semibold">
                  {previewReport.id}
                </span>
                <h3 className="font-bold text-ink-900 text-base">{previewReport.name}</h3>
              </div>
              <button
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="bg-paper p-3 rounded-lg border border-line space-y-1">
                ...
                <p className="font-medium text-ink-700">{previewReport.type}</p>
              </div>
              <div className="bg-paper p-3 rounded-lg border border-line space-y-1">
                <span className="text-ink-500">Priority Level</span>
                <p className="font-medium text-ink-700">{previewReport.priority}</p>
              </div>
              <div className="bg-paper p-3 rounded-lg border border-line space-y-1">
                <span className="text-ink-500">Generated By</span>
                <p className="font-medium text-ink-700">{previewReport.generatedBy}</p>
              </div>
              <div className="bg-paper p-3 rounded-lg border border-line space-y-1">
                <span className="text-ink-500">Execution Status</span>
                <p className="font-medium text-emerald-400">{previewReport.status}</p>
              </div>
            </div>

            <div className="space-y-1 text-xs">
              <span className="text-ink-500">Analytics Range</span>
              <p className="text-ink-700 bg-paper p-2.5 rounded-lg border border-line">
            ...
            <div className="flex items-center justify-end space-x-3 pt-3 border-t border-line text-xs">
              ...
              <button className="px-4 py-2 rounded-lg bg-blue-600 text-ink-900 hover:bg-blue-500 font-medium flex items-center space-x-1.5">
                <Download className="w-3.5 h-3.5" />
